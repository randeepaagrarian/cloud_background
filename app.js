...
let sendIncompleteSalesReport = schedule.scheduleJob(incompleteSalesReportScheduler, function() {
    ...
    async.series([
        function(callback) {
            Database.getIncompleteSalesFrom201810(callback)
        }
    ], function(err, data) {
        ...
        HTMLString = HTMLString + "<h4>Incomplete Sales from 2018-10</h4>"
        HTMLString = HTMLString + "<p>There are <b>" + sales.length + "</b> incomplete sales from 2018-10</p>"
        ...
        const mailOptions = {
            ...
            subject: 'Incomplete Sales from 2018-10',
            html: HTMLString
        }
